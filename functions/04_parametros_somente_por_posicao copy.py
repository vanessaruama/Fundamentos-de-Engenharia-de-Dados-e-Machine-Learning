# Parâmetros somente por posição são definidos usando a barra (/) na definição da função.
...
# Esse trecho esta invalido porque os parâmetros modelo, ano e placa são definidos como parâmetros somente por posição,
